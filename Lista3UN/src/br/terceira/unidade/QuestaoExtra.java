...
public class QuestaoExtra {
	...
	de 18 litros, que custam R$ 80,00. Informe ao usuário a quantidades de latas de tinta a serem compradas e o preço total.
		...
		public static void main(String[] args) {
			...
			//System.out.println("Quantidade necessaria de latas: " + Math.floor(latasnecessarias)); --> O floor seria para numueros decimais.
			System.out.printf("Total a pagar: R$%.2f", totalpagar);
			System.out.println("\nObs.: Cada lata de tinta custa R$ 80,00.");
